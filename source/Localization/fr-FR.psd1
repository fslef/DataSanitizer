@{
    "New-DsFolder.Start"                         = "Démarrage de l'initialisation de la structure de dossiers de DataSanitizer à : {0}"
    "New-DsFolder.AddingConfigFolder"            = "Ajout du dossier _Config sous la racine : {0}"
    "New-DsFolder.AddingIntermediateFolder"      = "Ajout du dossier Intermediate {0} sous la racine {0}"
    "New-DsFolder.AddingLogFolder"               = "Ajout du dossier de Log sous: {0}"
    "New-DsFolder.AddingLogInputFolder"          = "Ajout du dossier de Log Input sous: {0}"
    "New-DsFolder.AddingLogWorkingFolder"        = "Ajout du dossier de Log Working (_WorkingFolder) sous: {0}"
    "New-DsFolder.AddingConfigFile"              = "Ajout du fichier de configuration DataSanitizer.cfg.json"
    "New-DsFolder.AddingDetectionRulesFile"      = "Ajout du fichier de configuration DetectionRules.cfg.json dans : {0}"
