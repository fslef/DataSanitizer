@{
    ...
    AVERTISSEMENT: Cet outil d'anonymisation des données est fourni «en l'état» sans garantie d'aucune sorte,
    expresse ou implicite, y compris, mais sans s'y limiter, les garanties implicites de qualité marchande et
    d'adéquation à un usage particulier. Il est possible qu'il ne détecte pas toutes les données devant être anonymisées.
    Par conséquent, l'utilisateur doit examiner le contenu des données avant de les transmettre à un tiers interne ou externe.
'@
