function New-DsFolder {
    ...
    process {
        ...
        Set-PSFConfig -Module DataSanitizer -Name 'Path.DSLogInputFolder' -Value $LogInputFolderPath

        # Also add the _WorkingFolder parameter
        ...
        New-Item -Path $LogFolderPath -Name "Working" -ItemType Directory | Out-Null
        [PsfDirectorySingle] $LogWorkingFolderPath = Join-Path -Path $LogFolderPath -ChildPath "Working"
        Set-PSFConfig -Module DataSanitizer -Name 'Path.DSLogWorkingFolder' -Value $LogWorkingFolderPath
        ...
        $config = [PSCustomObject]@{
            ...
            Static  = [PSCustomObject]@{
                ...
                "DataSanitizer.path.DSLogInputFolder"   = $LogInputFolderPath
                "DataSanitizer.path.DSLogWorkingFolder" = $LogWorkingFolderPath
            }
        }
